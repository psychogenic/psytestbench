...
def listAll():
    print(OScope.listResources())
    
def getDSO(devAddress='USB0::6833::1230::DS1ZA181104442::0::INSTR'):
    return OScope(devAddress)

def getSigGen(devAddress='USB0::26198::2100::3568543393::0::INSTR'):
    return SigGen(devAddress)

def getPowerSupply(devAddress='USB0::1155::30016::SPD3EGFQ6R2092::0::INSTR'):
    return BenchSupply(devAddress)
